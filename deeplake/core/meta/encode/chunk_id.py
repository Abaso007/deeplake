...
class ChunkIdEncoder(Encoder, DeepLakeMemoryObject):
    ...
    def num_chunks(self) -> int:
        return 0 if self.num_samples == 0 else len(self._encoded)
    ...
    def __getitem__(
        ...
        while (
            row_index < len(self._encoded)
            and self._encoded[row_index][LAST_SEEN_INDEX_COLUMN]
            == local_sample_index
        ):
